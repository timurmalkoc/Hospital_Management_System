...
export default function ViewAccount(props){
    ...
    const { personId } = useParams()
        ...
        useEffect(() => {
            ...
            fetch(`${props.base_url}/viewuser/${personId}` ,{
                headers: myHeaders
            })
            .then(res => res.json())
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                          <button type="button"  onClick={()=> navigate('/viewaccount')} className="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                          <a onClick={freeze} className="btn btn-danger" data-bs-dismiss="modal">Freeze</a>
                        </div>
                    </div>
                  </div>
                </div>
